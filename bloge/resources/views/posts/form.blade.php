                ...
                <div class="flex-col">
                    <div class="flex-row">
                        ...
                        <div>
                            ...
                            <x-text-input id="price" name="price" type="text" class="mt-1 block w-full" :value="$post->price ?? old('price')" required autofocus />
                        ...
                        <div class="item-flex">
                            ...
                            @foreach ($tags as $tag)
                                <h3><input type="checkbox" name="tags[]" value="{{ $tag->id }}">{{ $tag->name }}</h3>
                            @endforeach
