<template>
    <div class="product_box gird-4">
        <h5>Id: {{ product.id }} | <span>Stock: {{ product.inventory }}</span> | <span>Tags: {{ product.tag_name }}</span> </h5>
        <p><span>Category: {{ product.category_name }} </span> </p>
        <div class="product_image">
            <img v-if="product.featured_image" :src="'http://localhost:8000/storage/'+product.featured_image" alt="" srcset="">
            <img v-else src="https://tinyurl.com/3mp85men" alt="" srcset="">
        ...
        <div class="product_header">
            <a href="#">
                <div class="product_title">
                    ...
                    <h4 class="heading product_price"> $ {{ product.price }}
                    </h4>
                </div>

                <span class="sub-heading">{{ product.content }}</span>
                <!-- <span class="sub-heading">{{ product.content | trimWords(10) }}</span> -->
            </a>
        </div>
        ...
        <div class="clock-btn">
            ...
            <div class="product_action">
                ...
                <button @click="remove" class="button" >
                    Delete
                </button>
